<aside class="main-sidebar sidebar-dark-primary elevation-3">
    ...
    <a href="index3.html" class="brand-link">
      <img src="./images/logo_cms.jpg" alt="AdminLTE Logo" class="brand-image img-circle elevation-2"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Citra Media Solusindo</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="submanagerlist.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Sub Manager List</p>
                </a>
              </li>
            </ul>
          </li>
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
               ...
               <li class="nav-item">
                <a href="customerlist_notverified.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Customer List Not Verified</p>
                </a>
              </li>
              <li class="nav-item">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="nodelist.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Node List</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="poollist.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Pool List</p>
                </a>
              </li>
               <li class="nav-item">
                <a href="chpoollist.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Childpool List</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="customer_invoice.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Invoice</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="billinglist.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Billing</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="vendorlist.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Vendor List</p>
                </a>
              </li>
